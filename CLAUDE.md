# Meal Rules — Fridge to Feast

## Owner
Tushara Vepakomma. South Indian Telugu vegetarian with IBS.
...
After special selected → ask: 'Do you have yogurt today?'
Yes → raita | No → pickle
...
Kakarakaya, Sorakaya, Beerakaya, Dosakaya,
Tomatoes, Palakura, Dondakaya, Bendakaya,
Gongura, Carrot, Beans, Potatoes, Tofu,
Pudina, Methi, Kothimeera, Lemons
...
## YouTube Links
After every recipe add a search button:
Label: 'Watch in Telugu ▶️'
